					...
					<Col md='4'>
						<div className='wrapper'>
							...
							<div className='description'>
								...
								who expresses him- or herself through a medium".
								He is a descriptive term applied to a person who
								engages in an activity deemed to be an art. An
								artist also may be defined unofficially as "a
								...
								<Row className='align-items-center text-left'>
									...
									>
										...
										<p className='description'>
											We aim high at being focused on
											building relationships with our
											clients and community. Using our
											creative gifts drives this
											foundation.
										</p>
						...
						<Container>
							<Row className='align-items-center'>
								<Col className='mx-auto' lg='5' md='10' xs='12'>
									...
									<p className='description'>
										5,000 capacity venue, holding some of
										the latest technology lighting with a 24
										colour laser system Amnesia is one of
										the islands most legendary clubs.
									</p>
									<Row>
							...
							<Container>
								<Row>
									...
									>
										...
										<h4 className='description'>
											This is the paragraph where you can
											write more details about your team.
											Keep you user engaged by providing
											meaningful information.
										</h4>
									</Col>
