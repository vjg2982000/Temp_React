...
class ProductPage extends React.Component {
	...
	addQuantity = () => {
		this.setState({
			quantity:
				this.state.quantity === 100 ? 100 : this.state.quantity + 1,
		});
	};
	render() {
		return (
							...
							<Row>
								...
								<Col className='mx-auto' lg='6' md='12'>
									...
									<p className='description'>
										...
										has the fit and coverage of a bikini in
										a one-piece silhouette. This fuchsia
										style is crafted from the label's
										sculpting peau douce fabric and has
										flattering cutouts through the torso and
										back. Wear yours with mirrored
								...
								<Row>
									...
									>
										...
										<h4 className='description'>
											You need more information? Check
											what other persons are saying about
											our product. They are very happy
											with their purchase.
										</h4>
									</Col>
								</Row>
								<Row className='mt-5'>
										...
										<Card className='card-testimonial'>
											...
											<CardBody>
												<p className='card-description'>
													The networking at Web Summit
													is like no other European
													tech conference.
												</p>
											</CardBody>
									...
									<Col md='4'>
										<Card className='card-testimonial'>
											...
											<CardBody>
												<p className='card-description'>
													The connections you make at
													Web Summit are unparalleled,
													we met users all over the
													world.
												</p>
											</CardBody>
											<div className='icon icon-primary'>
									...
									<Card className='card-product'>
										...
										<CardBody>
											...
											<div className='card-description'>
												Dolce &amp; Gabbana's 'Greta'
												tote has been crafted in Italy
												from hard-wearing red
												textured-leather.
											</div>
											<CardFooter>
								...
								<Col lg='3' md='6'>
									<Card className='card-product'>
										...
										<CardBody>
											...
											<div className='card-description'>
												Balmain's mid-rise skinny jeans
												are cut with stretch to ensure
												they retain their second-skin
								...
								<Col lg='3' md='6'>
									<Card className='card-product'>
										...
										<CardBody>
											...
											<div className='card-description'>
												Balenciaga's black
												textured-leather wallet is
												finished with the label's iconic
												'Giant' studs. This is where you
												can...
											</div>
											<CardFooter>
												<div className='price-container'>
