					...
					<div className='page-header header-filter page-header-small'>
						<div
							...
							style={{
								backgroundImage:
									'url(' +
									require('assets/img/lucas-benjamin.jpg') +
									')',
							}}
						/>
						<Container>
							<Row>
								...
								>
									...
									<h4 className='description'>
										To get started, you will need to choose
										a plan for your needs. You have Free
										Unlimited Updates and Premium Support on
										each package.
									</h4>
								</Col>
							</Row>
								...
								<Row>
									...
									<Col md='4'>
										<div className='info info-hover'>
											...
											<p className='description'>
												Unify data from Facebook,
												Instagram, Twitter, LinkedIn,
												and Youtube to gain rich
												insights.
											</p>
										</div>
									</Col>
									<Col md='4'>
										<div className='info info-hover'>
											...
											<p className='description'>
												Track actions taken on your
												website, understand the impact
												on your bottom line.
											</p>
										</div>
									</Col>
							...
							<div className='page-header header-filter'>
								<div
									...
									style={{
										backgroundImage:
											'url(' +
											require('assets/img/andre-benz.jpg') +
											')',
									}}
								/>
								<Container>
							...
							<Container>
								<Row>
									...
									>
										...
										<h4 className='description'>
											By accepting this, you will be kept
